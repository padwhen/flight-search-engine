...
export const OneWay = () => {
    ...
    const {airport1, setAirport1, airport2, setAirport2} = useAirportContext()
    ...
    const handleSelectAirport2 = (airportName) => {
        setFromAddress2('')
        setAirport2(airportName)
    }

    const handleValidation = () => {
        if (!fromAddress1 || !fromAddress2 || !airport1 || !airport2) {
    ...
    return (
                ...
                <div className="flex flex-row space-x-2 w-full">
                    ...
                    >
                        <input
                            ...
                            className="cursor-pointer focus:outline-none w-full border border-gray-300 px-4 py-2 rounded"
                        />
                    </StandaloneSearchBox>
                    ...
                    >
                        <input
                            ...
                            value={airport2 ? airport2 : fromAddress2}
        ...
        <div className="flex flex-row space-x-2 w-full mt-1">
            <input type='datetime-local' placeholder="Departure" className="cursor-pointer focus:outline-none w-full border border-gray-300 px-4 py-2 rounded w-2/3" />
            <input type='number' value={passenger} onChange={handlePassengerChange} className="cursor-pointer focus:outline-none w-full border border-gray-300 px-4 py-2 rounded w-1/3" />
        </div>
        <div>
