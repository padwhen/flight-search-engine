...
export const RoundTrip = () => {
    ...
    const {airport1, airport2, setAirport1, setAirport2} = useAirportContext()
    ...
    return (
        ...
        <div className="flex flex-row space-x-2 w-full mt-1">
            <input type='datetime-local' placeholder="Departure" className="focus:outline-none w-full border border-gray-300 px-4 py-2 rounded w-2/3" />
            <input type='number' value={1} className="focus:outline-none w-full border border-gray-300 px-4 py-2 rounded w-1/3" />
        </div>
        <div>
